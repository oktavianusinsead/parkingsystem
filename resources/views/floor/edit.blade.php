{{Form::model($floor, array('route' => array('floor.update', $floor->id), 'method' => 'PUT')) }}
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group  col-md-12">
            {{Form::label('floor_level',__('Level'),array('class'=>'form-label'))}}
            {{Form::number('floor_level',null,array('class'=>'form-control','placeholder'=>__('Enter floor level')))}}
        </div>
        <div class="form-group  col-md-12">
