                ...
                <div class="card-body">
                    <table class="display dataTable cell-border ">
                        ...
                        <tr>
                            ...
                            <td>
                                <b class="discoutedPrice"> <?php echo e(subscriptionPaymentSettings()['CURRENCY_SYMBOL']); ?><?php echo e($subscription->package_amount); ?></b>
                            </td>
                                ...
                                <div class="setting-card action-menu">
                                    <div class="form-group">
                                        <div class="form-check custom-chek">
                                            ...
                                            <label class="form-check-label" for="have_bank_tran_coupon"><?php echo e(__('Have a Discount Coupon Code?')); ?> </label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body profile-user-box">
                                <form
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 ">
                                            <input type="button" value="<?php echo e(__('Coupon Apply')); ?>"  class="btn btn-warning packageCouponApplyBtn d-none coupon_div">
                                ...
                                <div class="setting-card action-menu">
                                    <div class="form-group">
                                        <div class="form-check custom-chek">
                                            ...
                                            <label class="form-check-label" for="have_stripe_coupon"><?php echo e(__('Have a Discount Coupon Code?')); ?> </label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="setting-card action-menu">
                                    <div class="form-group">
                                        <div class="form-check custom-chek">
                                            ...
                                            <label class="form-check-label" for="have_paypal_coupon"><?php echo e(__('Have a Discount Coupon Code?')); ?> </label>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/user/parkingsystem/resources/views/subscription/show.blade.php ENDPATH**/ ?>