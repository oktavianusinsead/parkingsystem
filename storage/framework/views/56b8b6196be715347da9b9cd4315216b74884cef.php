...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group">
            <?php echo e(Form::label('parking_zone_limit',__('Parking Zone Limit'),array('class'=>'form-label'))); ?>

            <?php echo e(Form::number('parking_zone_limit',null,array('class'=>'form-control','placeholder'=>__('Enter parking zone limit'),'required'=>'required'))); ?>
...
<?php /**PATH /Users/oktavianusmatthew/easypark/main_file/resources/views/subscription/edit.blade.php ENDPATH**/ ?>