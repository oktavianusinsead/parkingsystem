...
<?php $__env->startSection('breadcrumb'); ?>
    <ul class="breadcrumb mb-0">
        ...
        <li class="breadcrumb-item active">
            <a href="#"><?php echo e(__('RFID Extend')); ?></a>
        </li>
    </ul>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('card-action-btn'); ?>
    <?php if(Gate::check('create rfid vehicle')): ?>
        <a class="btn btn-primary btn-sm ml-20 customModal" href="#" data-size="lg"
           data-url="<?php echo e(route('rfid-extend.create')); ?>"
           data-title="<?php echo e(__('Create RFID Vehicle')); ?>"> <i class="ti-plus mr-5"></i><?php echo e(__('Create RFID Extend')); ?></a>
    <?php endif; ?>
<?php $__env->stopSection(); ?>
                                ...
                                <?php if(Gate::check('edit rfid vehicle') ||  Gate::check('delete rfid vehicle')): ?>
                                    <td class="text-right">
                                        <div class="cart-action">
                                            <?php echo Form::open(['method' => 'DELETE', 'route' => ['rfid-extend.destroy', $vehicle->id]]); ?>


                                            <?php if(Gate::check('edit rfid vehicle') ): ?>
                                                <a class="text-success customModal" data-bs-toggle="tooltip"
                                                   data-bs-original-title="<?php echo e(__('Edit')); ?>" data-size="lg" href="#"
                                                   data-url="<?php echo e(route('rfid-extend.edit',$vehicle->id)); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/user/parkingsystem/resources/views/rfid_extend/index.blade.php ENDPATH**/ ?>