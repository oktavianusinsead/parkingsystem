            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <?php echo e(Form::label('parking_prefix',__('Parking ID Prefix'),array('class'=>'form-label'))); ?>

                            <?php echo e(Form::text('parking_prefix',$settings['parking_prefix'],array('class'=>'form-control','placeholder'=>__('Enter parking id prefix')))); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/oktavianusmatthew/easypark/main_file/resources/views/settings/company.blade.php ENDPATH**/ ?>