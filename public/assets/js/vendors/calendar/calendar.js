var FullCalendar = function (e) {
    ...
    var un = {
            ...
            initialView: "",
            aspectRatio: 1.35,
            codexEvntFilter: {start: "title", center: "", end: "today prev,next"},
            weekends: !0,
            weekNumbers: !1,
        ...
        fn = {codexEvntFilter: hn, footerToolbar: hn, buttonText: hn, buttonHints: hn, buttonIcons: hn};
    ...
    var Lr = function () {
        ...
        return e.prototype.createMarker = function (e) {
            ...
            }(e, t), $e(n) ? {unit: "hour", value: n} : (n = function (e, t) {
                return (t.valueOf() - e.valueOf()) / 6e4
            }(e, t), $e(n) ? {unit: "minute", value: n} : (n = function (e, t) {
                return (t.valueOf() - e.valueOf()) / 1e3
            }(e, t), $e(n) ? {unit: "second", value: n} : {unit: "millisecond", value: t.valueOf() - e.valueOf()})))
    ...
    var Cl = function (e) {
        ...
        views: {
            dayGrid: {component: bl, dateProfileGeneratorClass: Cl},
    ...
    }(to), _l = ln({hour: "numeric", minute: "2-digit", omitZeroMinute: !0, meridiem: "short"});
    ...
    var xl = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            return this.props.slatMetas.map((function (e) {
                return _o("tr", {key: e.key}, _o(Tl, r({}, e)))
            }))
        }, t
    }(Uo), Ml = ln({week: "short"}), Il = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.allDaySplitter = new Rl, t.headerElRef = ko(), t.rootElRef = ko(), t.scrollerElRef = ko(), t.state = {slatCoords: null}, t.handleScrollTopRequest = function (e) {
            ...
            return f.push({
                ...
                chunks: [{
                    key: "axis", content: function (e) {
                        ...
                        }, e.tableColGroupNode, _o("tbody", null, _o(xl, {slatMetas: i}))), _o("div", {className: "fc-timegrid-now-indicator-container"}, _o(Ca, {unit: h ? "minute" : "day"}, (function (e) {
    ...
    var Nl = function () {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return _o("tbody", null, e.slatMetas.map((function (i, a) {
                ...
                return _o("tr", {key: i.key, ref: o.createRef(i.key)}, e.axis && _o(Tl, r({}, i)), _o(Yo, {
                    hookProps: s,
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            }, e.tableColGroupNode, _o(Hl, {slatElRefs: this.slatElRefs, axis: e.axis, slatMetas: e.slatMetas})))
        }, t.prototype.componentDidMount = function () {
            this.updateSizing()
        }, t.prototype.componentDidUpdate = function () {
            this.updateSizing()
        ...
        var i, a, s, l = Xi(o.addSegs(e)), u = function (e) {
            var t = e.entriesByLevel, n = jl((function (e, t) {
                ...
                var a = function (e, t, n) {
                    ...
                    return null
                }(e, o, i), s = Fl(a, n), l = t[o][i];
                return [r(r({}, l), {nextLevelNodes: s[0]}), l.thickness + s[1]]
            }));
            return Fl(t.length ? {level: 0, lateralStart: 0, lateralEnd: t[0].length} : null, n)[0]
        }(o);
    ...
    var ql = ln({hour: "numeric", minute: "2-digit", meridiem: !1}), Yl = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return _o(us, {
                ...
                }, u, t.extraDataAttrs), _o("div", {className: "fc-timegrid-col-frame"}, _o("div", {className: "fc-timegrid-col-bg"}, e.renderFillSegs(t.businessHourSegs, "non-business"), e.renderFillSegs(t.bgEventSegs, "bg-event"), e.renderFillSegs(t.dateSelectionSegs, "highlight")), _o("div", {className: "fc-timegrid-col-events"}, e.renderFgSegs(s, a, !1, !1, !1)), _o("div", {className: "fc-timegrid-col-events"}, e.renderFgSegs(i, {}, Boolean(t.eventDrag), Boolean(t.eventResize), Boolean(o))), _o("div", {className: "fc-timegrid-now-indicator-container"}, e.renderNowIndicator(t.nowIndicatorSegs)), _o(Zl, {
                    date: t.date,
                    dateProfile: t.dateProfile,
                    todayRange: t.todayRange,
                    extraHookProps: t.extraHookProps
            ...
            var a = this, s = this.context.options, l = s.eventMaxStack, u = s.eventShortHeight, c = s.eventOrderStrict,
                ...
                }(e, Gl(e, f, h, d), c, l), S = E.segPlacements, b = E.hiddenGroups;
            return _o(xo, null, this.renderHiddenGroups(b, e), S.map((function (e) {
                var s = e.seg, l = e.rect, c = s.eventRange.instance.instanceId, d = y || Boolean(!t[c] && l),
                    p = $l(l && l.span), f = !y && l ? a.computeSegHStyle(l) : {left: 0, right: 0},
            ...
            return _o(xo, null, e.map((function (e) {
                var n, c, d = $l(e.span), p = (n = e.entries, c = t, n.map((function (e) {
                    return c[e.index]
                })));
                return _o(Ul, {
                    key: Ft(Ss(p)),
    ...
    function Kl(e, t) {
        ...
        return _o(xo, null, e.map((function (e) {
            ...
            return _o("div", {key: t, style: {visibility: l[t] ? "hidden" : ""}}, _o(Yl, r({
                seg: e,
                isDragging: !1,
                isResizing: !1,
                isDateSelecting: !1,
    ...
    var tu = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return _o(Ca, {unit: a ? "minute" : "day"}, (function (l, u) {
                return _o(Ql, r({ref: e.timeColsRef}, e.slicer.sliceProps(t, o, null, n, s), {
                    forPrint: t.forPrint,
                    axis: t.axis,
                    dateProfile: o,
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return _o(Ca, {unit: "day"}, (function (e, n) {
                for (var a = [], d = 0; d < c.length; d += 1) {
                    ...
                    if (p) {
                        var f = Bt(t[d]), h = u + "-" + f;
                        a.push(_o(uu, {key: f, cellId: h, dayDate: t[d], todayRange: n}));
    ...
    var Su = zo({themeClasses: {bootstrap: Eu}}), bu = "https://www.googleapis.com/calendar/v3/calendars";
    var Du = zo({
        eventSourceDefs: [{
            parseMeta: function (e) {
